            ...
            <div class="container-fluid nopad">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6"><a class="btn btn-blue" style="padding:16%" href="AcceuilGestionnaire?action=QuestionsForum"> questions du Forum </a></div>
                        <div class="col-md-3 col-sm-6"><a class="btn btn-blue" style="padding:15%" href="AcceuilGestionnaire?action=creerPeriode">Renseigner une date de disponibilité</a></div>
                    </div>
                </div>
            </div>
