                ...
                <div class="container">
                    ...
                    <form method ="get" action="ServletAdmin" class="form-inline">
                        ...
                        <div class="form-group">
                            ...
                            <input type ="text" name="nom" class='form-control' style="margin-left:10px;"/>
                        </div>
                        <div class="form-group">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr> <td Width=15%><%=profil.getId()%></td>
                                ...
                                <td Width=15%><a style="color:grey" href="ServletAdmin?action=ModifierProfilMetier&idProfilMetier=<%=profil.getId()%>">Modifier</a></td>
                                <td Width=15%><a style="color:grey" href="ServletAdmin?action=SupprimerProfilMetier&idProfilMetier=<%=profil.getId()%>">Supprimer</a></td>
                                <%}%>   
                            </tr>
                        </table>  
                        <hr class="my-6">
